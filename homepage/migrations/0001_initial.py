    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 3, 19, 12, 24, 0, 336744))),
                ('price', models.IntegerField(default=0)),
                ('img', models.ImageField(blank=True, null=True, upload_to=homepage.models.img_path_bill)),
                ('status', models.CharField(choices=[], default='Waiting', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 3, 19, 12, 24, 0, 337012))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('drink', 'Đồ uống'), ('food', 'Đồ ăn'), ('entertainment', 'Giải trí'), ('service', 'Dịch vụ khác')], max_length=20)),
                ('price', models.IntegerField(default=0)),
                ('img', models.ImageField(default='default.jpg', upload_to=homepage.models.img_path_product)),
                ('describe', models.TextField(null=True)),
                ('like', models.IntegerField(default=0)),
                ('dislike', models.IntegerField(default=0)),
                ('time', models.DateTimeField(default=datetime.datetime(2025, 3, 19, 12, 24, 0, 336586))),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 3, 19, 12, 24, 0, 337794))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(default=datetime.datetime(2025, 3, 19, 12, 24, 0, 337615))),
                ('content', models.TextField()),
                ('like', models.IntegerField(default=0)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.account')),
